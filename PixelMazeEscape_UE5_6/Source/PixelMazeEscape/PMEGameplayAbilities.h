...
protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="1.0"))
	float BaseDuration = 12.0f;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="0.0"))
	float DurationPerUpgradeStack = 3.0f;
...
protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="0.2"))
	float BaseDuration = 4.0f;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="0.0"))
	float DurationPerUpgradeStack = 1.5f;
...
protected:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="0.5"))
	float RadiusInTiles = 4.0f;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|Ability", meta=(ClampMin="0.1"))
