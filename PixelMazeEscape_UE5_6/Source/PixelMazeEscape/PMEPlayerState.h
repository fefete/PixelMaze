...
public:
	...
	UFUNCTION(BlueprintPure, Category="Pixel Maze|Player")
	bool HasReachedExit() const { return bReachedExit; }
	...
	UFUNCTION(BlueprintPure, Category="Pixel Maze|Score")
	int32 GetRunScore() const { return RunScore; }
	...
	UFUNCTION(BlueprintPure, Category="Pixel Maze|Score")
	int32 GetObjectivesActivated() const { return ObjectivesActivated; }
...
private:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
		meta=(AllowPrivateAccess="true"))
	TSubclassOf<UGameplayAbility> TorchAbilityClass;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
		meta=(AllowPrivateAccess="true"))
	TSubclassOf<UGameplayAbility> MapPulseAbilityClass;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
		meta=(AllowPrivateAccess="true"))
	TSubclassOf<UGameplayAbility> DecoyAbilityClass;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
		meta=(AllowPrivateAccess="true"))
	TSubclassOf<UGameplayAbility> LightBombAbilityClass;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Pixel Maze|GAS|Abilities",
		meta=(AllowPrivateAccess="true"))
	TSubclassOf<UGameplayAbility> MasterKeyAbilityClass;
