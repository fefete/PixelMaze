...
protected:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Patrol", meta=(ClampMin="0.0", ClampMax="5.0"))
    ...
    /** Detection radius measured in maze tiles. Detection is 360 degrees but requires line of sight. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="1.0", UIMin="1.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="10.0", UIMin="10.0"))
    float ChaseMovementSpeed = 245.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="10.0", UIMin="10.0"))
    float ReturnMovementSpeed = 195.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="0.02", ClampMax="2.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="0.02", ClampMax="1.0"))
    float ChaseBlockedRepathDelay = 0.10f;

    /** Consecutive failed path rebuilds before abandoning the chase safely. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="1", ClampMax="10"))
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Pixel Maze|Enemy|Perception", meta=(ClampMin="0.0", ClampMax="2.0"))
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Pixel Maze|Enemy|Audio", meta=(ClampMin="0.1", ClampMax="3.0"))
    float EnemyStepDistanceInTiles = 0.72f;

    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Pixel Maze|Enemy|Audio", meta=(ClampMin="0.0", ClampMax="1.0"))
    float EnemyStepVolume = 0.44f;

    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Pixel Maze|Enemy|Audio", meta=(ClampMin="0.0", ClampMax="1.0"))
    float EnemyVocalVolume = 0.32f;

    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Pixel Maze|Enemy|Audio", meta=(ClampMin="1.0", ClampMax="60.0"))
...
private:
    ...
    bool MoveAlongActivePath(float DeltaSeconds, float Speed, bool bConsumeChaseBudget, const FVector* FinalExactLocation = nullptr);
